...
// bool beenVisited(HSLAPixel* pixel, unordered_set<HSLAPixel*> visited);

bool inTolerance(HSLAPixel* pixel1, HSLAPixel* pixel2, float tolerance);

bool inBounds(point* p, PNG* img);
} // namespace filler
